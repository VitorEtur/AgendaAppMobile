...
public class ConexaoBlock extends SQLiteOpenHelper {

    private static final String name = "bancoblock.db"; //*********** nome do banco de dados banco.db
    private static final int version = 1; //*********** versão 1

    public ConexaoBlock(Context context) {
    ...
    public void onCreate (SQLiteDatabase db) {
        db.execSQL("create table contatoblock1(id INTEGER PRIMARY KEY AUTOINCREMENT, " +
